    ...
    <div className="min-h-screen bg-fulboost-dark text-white">
      ...
      <AnimatedSection className="relative overflow-hidden pt-16 pb-32 lg:pt-24 lg:pb-40">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center space-x-2 px-6 py-2 border border-fulboost-red/30 rounded-full bg-fulboost-red/10 backdrop-blur-sm">
              <div className="w-2 h-2 bg-fulboost-red rounded-full animate-pulse"></div>
              <span className="text-sm font-bold text-fulboost-red">Live fulfilment center</span>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-fulboost-red font-bold text-lg mb-4">Geen verrassingen. Geen vertraging. Gewoon Fulboost.</p>
            
            <p className="max-w-3xl mx-auto text-xl text-fulboost-gray leading-relaxed mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
              {stats.map((stat, index) => (
                <div key={index} className="text-center p-6 bg-fulboost-darker/50 rounded-2xl border border-gray-800/50 backdrop-blur-sm">
                  <div className="text-3xl font-black text-fulboost-red mb-2">{stat.number}</div>
                  <div className="text-sm text-fulboost-gray font-medium">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <AnimatedSection className="relative py-24 bg-gradient-to-b from-fulboost-darker to-fulboost-dark">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {usps.map((usp, index) => (
              <div key={index} className="text-center p-6 bg-fulboost-darker rounded-2xl border border-gray-800 hover:border-fulboost-red/50 transition-all duration-300 hover:scale-105">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-fulboost-red/20 rounded-xl">
                    <usp.icon className="w-8 h-8 text-fulboost-red" />
                  </div>
                </div>
                <h3 className="text-xl font-bold text-white mb-2">{usp.title}</h3>
                <p className="text-fulboost-gray text-sm">{usp.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <AnimatedSection className="relative py-24 bg-gradient-to-b from-fulboost-dark to-fulboost-darker">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-6 py-2 border border-fulboost-red/30 rounded-full bg-fulboost-red/10 mb-8">
              <span className="text-sm font-bold text-fulboost-red">Onze diensten</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black mb-6">
            ...
            {services.map((service, index) => (
              <div key={index} className="bg-fulboost-darker rounded-2xl border border-gray-800 hover:border-fulboost-red/50 transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  <p className="text-fulboost-gray mb-6 text-lg">{service.description}</p>
                  <ul className="space-y-3">
                    {service.features.map((feature, i) => (
                      <li key={i} className="flex items-center">
                        <CheckCircle className="w-5 h-5 text-fulboost-red mr-3 flex-shrink-0" />
      ...
      <AnimatedSection className="relative py-24 bg-gradient-to-b from-fulboost-darker to-fulboost-dark">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-6 py-2 border border-fulboost-red/30 rounded-full bg-fulboost-red/10 mb-8">
              <span className="text-sm font-bold text-fulboost-red">Voor wie?</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="text-center p-6 bg-fulboost-darker rounded-2xl border border-gray-800">
                <div className="text-4xl font-black text-fulboost-red mb-4">🚀</div>
                <h3 className="text-xl font-bold mb-2">Starters</h3>
                <p className="text-fulboost-gray">Net begonnen? Wij ook. Laten we samen groeien.</p>
              </div>
              <div className="text-center p-6 bg-fulboost-darker rounded-2xl border border-gray-800">
                <div className="text-4xl font-black text-fulboost-red mb-4">⚡</div>
                <h3 className="text-xl font-bold mb-2">Groeiers</h3>
                <p className="text-fulboost-gray">Klaar om te schalen? Wij zijn er klaar voor.</p>
              </div>
              <div className="text-center p-6 bg-fulboost-darker rounded-2xl border border-gray-800">
                <div className="text-4xl font-black text-fulboost-red mb-4">🌍</div>
                <h3 className="text-xl font-bold mb-2">Internationale</h3>
                <p className="text-fulboost-gray">Europa veroveren? Wij regelen de logistiek.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-fulboost-darker p-8 rounded-2xl border border-gray-800">
              ...
              <div className="font-bold text-white">- EcoStyle</div>
            ...
            <div className="bg-fulboost-darker p-8 rounded-2xl border border-gray-800">
              ...
              <div className="font-bold text-white">- FitFuel</div>
              <div className="text-sm text-fulboost-red">1000% groei in 18 maanden</div>
            </div>
          </div>
        </div>
      </AnimatedSection>
